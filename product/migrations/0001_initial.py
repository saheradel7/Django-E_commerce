    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prand', models.CharField(blank=True, default='', max_length=200)),
                ('category', models.CharField(choices=[('Electronics', 'Electronics'), ('Laptops', 'Laptops'), ('Arts', 'Arts'), ('Food', 'Food'), ('Home', 'Home'), ('Kitchen', 'Kitchen')], max_length=200)),
